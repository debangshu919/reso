...
const client = new Client({ intents: ['GuildMessages', 'MessageContent', 'DirectMessages', 'GuildMembers', 'Guilds', 'GuildVoiceStates'], }); //Guilds, GuildMembers : REQUIRED 
...
client.manager = kazagumo; // Add this line
